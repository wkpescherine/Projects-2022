...
public class GearBuilder {
    ...
    //Armor Section
    String [] gearArmorQualitNames    = {"Tattered", "Worn","Ragged","Weakened", "Basic","Refined", "Excellent","Superior", "Legendary", "Mythical"};
    String [] gearArmorMaterialNames  = {"Wool","Cloth", "Hide", "Leather", "Studded", "Banded", "Chain", "Plated", "Etheral", "Astral"};
    String [] gearArmorTypes          = {"Helm", "Chest", "Legs", "Boots", "Shoulder", "Arms", "Gloves", "Buckler", "Kite SHield", "Yower Shield"};
